...
#if defined(NDEBUG)
# error "LitecoinGold cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xf1e915e7cfe3e91094bab692a15dec5daca96ddb2a7fe7dfc5698e02fad860ce");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // LitecoinGold: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "LitecoinGold Signed Message:\n";
...
{
    // LitecoinGold: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // LitecoinGold: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // LitecoinGold: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1508014515, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "6818004979317331731347469675392125962617767975933054835026069370494447";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0450f185408924d0dbe37824c3a1a49b4b425b6341cc776d465280ad57f194550daf17d01e208fbe9d42a66abe3f651e0f30470c58073bd33e110f22b1d7c5ae5b") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1508014515;
        ...
        assert(block.hashMerkleRoot == uint256("0xaeb1f6db5b5c43fde6c9bbf0cf9fc129ff966c2c644e68abe8f51b0430a14a39"));
...
unsigned char pchMessageStart[4] = { 0x67, 0x16, 0x88, 0xf6 }; // LitecoinGold: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("LitecoinGoldMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("LitecoinGoldMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static LitecoinGoldMiner(CWallet *pwallet)
{
    printf("LitecoinGoldMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("litecoingold-miner");
    ...
    try { loop {
        ...
        printf("Running LitecoinGoldMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("LitecoinGoldMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&LitecoinGoldMiner, pwallet));
}
